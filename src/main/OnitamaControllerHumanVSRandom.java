 ...
 * It updates every round for human player and random player.
 * It also print every round for this the board for human player and random player in order to run this game
 */
